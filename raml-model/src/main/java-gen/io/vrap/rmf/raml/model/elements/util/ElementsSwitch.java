/**
 */
package io.vrap.rmf.raml.model.elements.util;
 ...
 * @generated
 */
public class ElementsSwitch<T1> extends Switch<T1> {
	/**
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ElementsPackage.IDENTIFIABLE_ELEMENT: {
				IdentifiableElement identifiableElement = (IdentifiableElement)theEObject;
				T1 result = caseIdentifiableElement(identifiableElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ElementsPackage.DOCUMENTABLE_ELEMENT: {
				DocumentableElement documentableElement = (DocumentableElement)theEObject;
				T1 result = caseDocumentableElement(documentableElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public <T> T1 caseTypedElement(TypedElement<T> object) {
		return null;
	}
