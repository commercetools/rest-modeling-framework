...
public class ElementsAdapterFactory extends AdapterFactoryImpl {
	...
	protected ElementsSwitch<Adapter> modelSwitch =
		new ElementsSwitch<Adapter>() {
			...
			@Override
			public <T> Adapter caseTypedElement(TypedElement<T> object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link io.vrap.rmf.raml.model.elements.TypedElement <em>Typed Element</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
